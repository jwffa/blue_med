      ...
      <div className='relative flex items-center justify-between'>
        <div className='hidden lg:block'>
          <div className='max-w-[320px] absolute bottom-0'>
            <img className='w-full' src="../../components/bluemedQR/pics/wood-hand.png" alt="wood-hand" />
          </div>
        </div>
        ...
        <div className='pt-0 pb-12 lg:pb-12'>
          ...
          <img className='w-32 rounded-xl mt-10' src="../../components/bluemedQR/pics/qr.png" alt="" />
        </div>
      </div>
    </div>
  )
